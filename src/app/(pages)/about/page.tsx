      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p className="hero-description">
            Our mission is to revolutionize agriculture by putting cutting-edge
            artificial intelligence directly into the hands of farmers, making
            farming smarter, more efficient, and more profitable.
          </p>
        </div>
        ...
        <div className="mission-cards">
          <div className="mission-card">
            ...
            <p className="mission-card-text">
              Advanced AI models provide hyper-local weather forecasts up to 14
              days ahead, helping farmers plan their activities with confidence.
            </p>
          </div>
          ...
          <div className="mission-card">
            ...
            <p className="mission-card-text">
              ...
              while ensuring crops receive optimal hydration at the right time.
            </p>
          </div>
          ...
          <div className="story-grid">
            <div className="story-content">
              ...
              <p className="story-text">
                Founded by a team of agricultural scientists and AI researchers,
                our initiative was born from witnessing the daily challenges
                farmers face. We saw how unpredictable weather, inefficient
                resource management, and lack of data-driven insights were
            ...
            <div className="testimonial-card">
              <blockquote className="testimonial-quote">
                "This AI system has transformed how I manage my 200-acre farm. I
                now make decisions based on data, not guesswork, and my profits
                have increased by 35% in just two seasons."
              </blockquote>
        ...
        <div className="how-it-works-container">
          ...
          <div className="how-it-works-grid">
            ...
            <div className="how-it-works-item">
              ...
              <p className="how-it-works-text">
                Machine learning algorithms process this data alongside weather
                forecasts and historical patterns to generate personalized
                recommendations.
              </p>
            </div>
          ...
          <div className="impact-grid">
            <div className="impact-card blue-light">
              ...
              <p className="impact-text">
                Farmland now operating with AI-driven efficiency across multiple
                continents.
              </p>
            </div>
      ...
      <section className="vision-section">
        <div className="vision-container">
          ...
          <p className="vision-description">
            ...
            location, has access to the same advanced agricultural intelligence
            that was once available only to industrial operations. Through AI,
            we're democratizing precision agriculture and building a more
